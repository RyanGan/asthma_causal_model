...
msm.fun <- function(data, y, a, w){ 
  ...
  mod1 <- glm(edvisit ~ inbuff, data = df_sample, 
                 family = "binomial"(link = "logit"))
...
# simple models ----
# risk diff
rd_mod <- tidy(glm(edvisit ~ inbuff, data = asthma_df, 
...
rd_95ci
# risk ratio
rr_mod <- tidy(glm(edvisit ~ inbuff, data = asthma_df, 
